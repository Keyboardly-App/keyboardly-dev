...
import app.keyboardly.samplekeyboard.components.expandableView.ExpandableState
import app.keyboardly.samplekeyboard.components.expandableView.ExpandableStateListener
import app.keyboardly.samplekeyboard.components.expandableView.ExpandableView
import app.keyboardly.samplekeyboard.components.keyboard.controllers.DefaultKeyboardController
import app.keyboardly.samplekeyboard.components.keyboard.controllers.KeyboardController
import app.keyboardly.samplekeyboard.components.keyboard.controllers.NumberDecimalKeyboardController
import app.keyboardly.samplekeyboard.components.keyboard.layouts.KeyboardLayout
import app.keyboardly.samplekeyboard.components.keyboard.layouts.NumberDecimalKeyboardLayout
import app.keyboardly.samplekeyboard.components.keyboard.layouts.NumberKeyboardLayout
import app.keyboardly.samplekeyboard.components.keyboard.layouts.QwertyKeyboardLayout
import app.keyboardly.samplekeyboard.components.textFields.CustomTextField
import app.keyboardly.samplekeyboard.components.utilities.ComponentUtils
import java.util.*
    ...
    private fun createKeyboardLayout(type: KeyboardType, ic: InputConnection): KeyboardLayout? {
        return when(type) {
            ...
            KeyboardType.NUMBER_DECIMAL -> {
                NumberDecimalKeyboardLayout(context, createKeyboardController(type, ic))
            }
            KeyboardType.QWERTY -> {
                QwertyKeyboardLayout(context, createKeyboardController(type, ic))
            }
