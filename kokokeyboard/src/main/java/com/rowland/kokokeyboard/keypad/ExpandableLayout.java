...
import static com.rowland.kokokeyboard.keypad.ExpandableLayout.State.COLLAPSING;
...
import static com.rowland.kokokeyboard.keypad.ExpandableLayout.State.COLLAPSED;
import static com.rowland.kokokeyboard.keypad.ExpandableLayout.State.COLLAPSING;
import static com.rowland.kokokeyboard.keypad.ExpandableLayout.State.EXPANDED;
import static com.rowland.kokokeyboard.keypad.ExpandableLayout.State.EXPANDING;
...
public class ExpandableLayout extends FrameLayout {
   ...
   private class ExpansionListener implements Animator.AnimatorListener {
      ...
      public void onAnimationStart(Animator animation) {
         state = targetExpansion == 0 ? COLLAPSING : State.EXPANDING;
      }
